...
public class Text {
    ...
    public static void init(){
        ...
        data.put("ERROR_COUPON_ROOT_INACTIVE","Заказ после которого был получен купон был отменен или не оплачен? Купон считается не действительным если заказ не оплачен!");
